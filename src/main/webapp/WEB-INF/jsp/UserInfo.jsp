...
function fn_UserCk(){
	...
	$.ajax({
		type:"GET",
		url:"http://localhost:9085/user/detailInfo/" + $("#mberId").val(),
		contentType: 'application/json; charset=utf-8',
		timeout:(1000*30),
		success:function(returnData){
			...
			var j = JSON.stringify(returnData);
...
<!-- <form id="mberManageVO" name="mberManageVO" >  -->
	...
	<tbody>
		...
		<!-- 일반회원아이디 -->
		<tr>
			<th><label for="mberId">사용자아이디</label> <span class="pilsu">*</span></th>
			<td class="left">
<!-- 				<input id="mberId" name="mberId" title="일반회원아이디 입력" style="width:80%;" readonly="readonly" type="text" value="" size="20" maxlength="20"/> -->
				<input id="mberId" name="mberId" title="아이디 입력" onchange="idmodify()" style="width:80%;" type="text" value="" size="20" maxlength="20"/>
				<button id="btnMbrId" class="btn_s2" onClick="fn_UserCk()" title="중복 아이디 검색">중복아이디 검색</button>
				<div></div>
			</td>
		</tr>
		...
		<!-- 일반회원이름 -->
		<tr>
			<th><label for="mberNm">사용자명</label> <span class="pilsu">*</span></th>
			<td class="left">
