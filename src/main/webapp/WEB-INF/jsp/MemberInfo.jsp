...
<link type="text/css" rel="stylesheet" href="/egovframework-all-in-one/css/egovframework/com/com.css">
...
<meta http-equiv="content-type" content="text/html; charset=utf-8">
<link type="text/css" rel="stylesheet" href="/egovframework-all-in-one/css/egovframework/com/com.css">
<script type="text/javascript" src="/egovframework-all-in-one/validator.do"></script>
<script type="text/javascript"> 
...
<script type="text/javascript" src="/egovframework-all-in-one/js/egovframework/com/sym/ccm/zip/EgovZipPopup.js" ></script>
<script src="/egovframework-all-in-one/js/egovframework/com/cmm/jquery.js"></script>
...
<form id="mberManageVO" name="mberManageVO" action="" method="post"> 
