...
import egovframework.com.user.dao.MemberVo;
...
//		@RequestBody
    ...
    @ApiImplicitParams({
//    	@ApiImplicitParam(name = "Member", value = "회원정보", required = true, dataType = "json", paramType = "path" , defaultValue = "")
    })
    @ApiResponses({
	...
	public String MemberAprovRequest(@RequestBody MemberVo param) throws Exception {
		String rtn = "";
...
//		sqlInpt.put("MBER_ID", map.get("mberId"));								//회원ID.........................................................
		sqlInpt.put("MBER_ID", param.getMemberId());	
		
		//SHA-256 암호화
		String pw = SecuritySha.SHA256(param.getPassword());
...
//		sqlInpt.put("PASSWORD", map.get("password"));						//비밀번호.................................................................
		...
		sqlInpt.put("MBER_FXNUM", param.getMberFxnum());        			//회원팩스번호.................................................................
		sqlInpt.put("MBER_EMAIL_ADRES", param.getMberEmailAdres());	//회원이메일주소.................................................................
	...
	//json형태의 String으로 받는....   --> swagger 에 보여지는게 마음에 안들어 바꿉니다....ㅠ.ㅠ
//	@ApiOperation(value = "회원가입요청", notes = "회원가입 요청을 합니다.")
//    @ApiImplicitParams({
...
//    	@ApiImplicitParam(name = "MemberVo", value = "회원정보", required = true, dataType = "json", paramType = "path" , defaultValue = "")
